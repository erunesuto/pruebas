...
public class itemGravedad : MonoBehaviour
{

    public int puntosGanadosGravedad = 1;
    ...
    void OnTriggerEnter2D(Collider2D collider)
    {
        ...
        {
            NotificationCenter.DefaultCenter().PostNotification(this, "IncrementarPuntosGravedad", puntosGanadosGravedad);
        }
        Destroy(gameObject);
    }
}
